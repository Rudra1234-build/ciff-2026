...
export interface _SERVICE {
  ...
  'addComment' : ActorMethod<[string, string, string], bigint>,
  'addRating' : ActorMethod<[string, string, bigint], undefined>,
  'getAllSubmissions' : ActorMethod<[], Array<FilmSubmission>>,
  'getAverageRating' : ActorMethod<[string], number>,
  'getComments' : ActorMethod<[string], Array<Comment>>,
  'getRatings' : ActorMethod<[string], Array<Rating>>,
  'submitFilm' : ActorMethod<
    [
      string,
      string,
      string,
