...
import type { ExternalBlob as _ExternalBlob, FilmSubmission as _FilmSubmission, Time as _Time, _ImmutableObjectStorageRefillInformation as __ImmutableObjectStorageRefillInformation, _ImmutableObjectStorageRefillResult as __ImmutableObjectStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addComment(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async addRating(arg0: string, arg1: string, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllSubmissions(): Promise<Array<FilmSubmission>> {
        if (this.processError) {
            try {
    ...
    async getRatings(arg0: string): Promise<Array<Rating>> {
        if (this.processError) {
            try {
    ...
    async submitFilm(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string, arg7: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitFilm(arg0, arg1, arg2, arg3, arg4, arg5, arg6, await to_candid_opt_n13(this._uploadFile, this._downloadFile, arg7));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_FilmSubmission_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FilmSubmission): Promise<FilmSubmission> {
...
async function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        videoBlob: record_opt_to_undefined(await from_candid_opt_n11(_uploadFile, _downloadFile, value.videoBlob)),
...
async function from_candid_vec_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_FilmSubmission>): Promise<Array<FilmSubmission>> {
    return await Promise.all(value.map(async (x)=>await from_candid_FilmSubmission_n9(_uploadFile, _downloadFile, x)));
}
